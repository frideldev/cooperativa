(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ng2-tooltip-directive', ['@angular/core','@angular/common','exports', '@angular/core', '@angular/common'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common,global['ng2-tooltip-directive'] = {}, global.ng.core, global.ng.common));
...
TooltipComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: TooltipComponent, selectors: [["tooltip"]], hostAttrs: [1, "tooltip"], hostVars: 20, hostBindings: function TooltipComponent_HostBindings(rf, ctx) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵclassProp("tooltip-shadow", ctx.hostClassShadow)("tooltip-light", ctx.hostClassLight)("tooltip-show", ctx.hostClassShow);
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(TooltipModule, { declarations: [TooltipDirective, TooltipComponent], imports: [ɵngcc1.CommonModule], exports: [TooltipDirective] }); })();
